...
import csv
import os
import zuo.bert.modeling as modeling
import zuo.bert.tokenization as tokenization
...
## Required parameters
BERT_BASE_DIR = "zuo/model_files/roberta-zh-large_law/"  # "../model_files/inference_with_reason/checkpoint_bert/"
# BERT_BASE_DIR_NEW = "zuo/model_files/roberta-layer12-01-new/"  # "../model_files/inference_with_reason/checkpoint_bert/"

flags.DEFINE_string("bert_config_file", BERT_BASE_DIR + "bert_config_large.json",
...
flags.DEFINE_integer("max_seq_length", 256, # 128
...
with graph.as_default():
    ...
    # print("save new checkpiont completed...")
    #########################################################################

    print("checkpoint1:",FLAGS.init_checkpoint)
